...
export class SupabaseRouteStorage {
  ...
  static async saveRoute(
    ...
    const insertData: RouteInsert = {
      user_id: userId,
      name: routeData.name,
      points: routeData.points as unknown as Database['public']['Tables']['routes']['Insert']['points'], // JSONB type
      distance,
    }
  ...
  static async updateRoute(
    ...
    const updateData: RouteUpdate = {
      ...
      ...(updates.points && {
        points: updates.points as unknown as Database['public']['Tables']['routes']['Update']['points'],
